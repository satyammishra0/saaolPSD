<section class="blog-list-section section-padding">
    <div class="blog-list-overlay"></div>
    <div class="blog-list-content">
        <div class="blog-list-first grid grid-total-center">
            <h2 class="home-heading">Our Latest Blog</h2>
            <div class="grid grid-center">
                <div class="gradient-line gradient-div"></div>
            </div>
        </div>

        <div class="blog-list-card-container grid grid-3">
