    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img loading="lazy" src="<?= get_assets() ?>images/saaol_logo.webp" alt="" height="45">
                    </span>
                    <span class="logo-lg">
                        <img loading="lazy" src="<?= get_assets() ?>images/saaol_logo.webp" alt="" height="45"> <span class="logo-txt">SAAOL</span>
                    </span>
                </a>
            ...
            <div class="topnav">
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link dropdown-toggle arrow-none" href="index.php" id="topnav-dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-invoice" role="button"><span data-key="t-invoices"><?php echo $language["Invoices"]; ?></span>
                                            <div class="arrow-down"></div>
                                        </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php if ($lang == 'en') { ?>
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="Header Language" height="28">
                    <?php } ?>
                    <?php if ($lang == 'es') { ?>
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="Header Language" height="28">
                    <?php } ?>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="?lang=en" class="dropdown-item notify-item">
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="user-image" class="28-1" height="12"> <span class="align-middle"> English </span>
                    </a>

                    <!-- item-->
                    <a href="?lang=de" class="dropdown-item notify-item">
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="user-image" class="28-1" height="12"> <span class="align-middle"> German </span>
                    </a>

                    <!-- item-->
                    <a href="?lang=it" class="dropdown-item notify-item">
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="user-image" class="28-1" height="12"> <span class="align-middle"> Italian </span>
                    </a>

                    <!-- item-->
                    <a href="?lang=es" class="dropdown-item notify-item">
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="user-image" class="28-1" height="12"> <span class="align-middle"> Spanish </span>
                    </a>

                    <!-- item-->
                    <a href="?lang=ru" class="dropdown-item notify-item">
                        <img loading="lazy" src="<?= get_assets() ?>images/flags/india.png" alt="user-image" class="28-1" height="12"> <span class="align-middle"> Russian </span>
                    </a>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 250px;">
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start bg-light">
                                <div class="flex-shrink-0">
                                    <img loading="lazy" src="<?= get_assets() ?>images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                </div>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                <div class="flex-shrink-0">
                                    <img loading="lazy" src="<?= get_assets() ?>images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img loading="lazy" class="rounded-circle header-profile-user" src="<?= get_assets() ?>images/users/avatar-1.jpg" alt="Header Avatar">
                </button>
